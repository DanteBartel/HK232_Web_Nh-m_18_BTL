...
<body>
    ...
    <div class="w-screen bg-gray-400">
        <div class="mx-auto w-[800px] p-8 bg-gray-100">
            ...
            <form action="index.php?action=books" method="post" onsubmit="return validateBook()">
                <!-- isbn -->
                <div>
                    <label for="isbn" class="font-bold">ISBN (13 kí tự, nullable):</label>
                </div>
                <div>
                    <input type="text" id="isbn" name="isbn" class="w-64">
                </div>
                <!-- name -->
                <div>
                ...
                <div>
                    <input type="text" id="name" name="name" class="w-64" required>
                </div>
                <!-- price -->
                <div>
                ...
                <div>
                    <input type="text" id="price" name="price" class="w-64" required>
                </div>
                <!-- author -->
                <div>
                ...
                <div>
                    <input type="text" id="author" name="author" class="w-64">
                </div>
                <!-- description -->
                <div>
                ...
                <div>
                    <input type="text" id="image" name="image" class="w-64">
                </div>
                <!-- quantity -->
                <div>
                ...
                <div>
                    <input type="text" id="quantity" name="quantity" class="w-64" required>
                </div>
                <!-- submit -->
                <div>
