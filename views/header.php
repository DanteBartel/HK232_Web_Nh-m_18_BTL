    ...
    <body>
        <div name="header" class="container mx-auto bg-violet-50 lg:px-32 sm:px-2 md:px-10">
            <nav class="flex justify-between items-center py-3">
                ...
                <div class="mx-auto">
                    <div class="relative w-full sm:w-64 md:w-96 xl:w-96">
                        <input type="text" class="hidden xl:block w-full py-2 pl-8 pr-4 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:outline-none" placeholder="Search">
