    ...
    <div class="border-2 rounded-3xl lg:max-w-screen-xl mx-auto py-8 grid grid-cols-1 md:grid-cols-2 bg-violet-500 bg-opacity-30 gap-8 lg:px-32 px-2 md:px-10">
            ...
            <div class="col-span-1 flex justify-center items-center px-6 order-1 md:order-2">
                <div class=" bg-white p-12 w-full h-full md:w-[400px] md:h-[500px] rounded-3xl shadow-md">
                    <h2 class="text-3xl font-semibold mb-4 uppercase text-center text-violet-900">Sign up</h2> 
                    <h3 class="text-md font-semibold italic mb-8 text-center">It's free and only takes a minute</h3>
                    <?php if (isset($error)): ?>
                    ...
                    <form action="index.php?action=signup" method="POST" onsubmit="return validateNewAccount()">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="email" name="email" placeholder="Fill in your Email" class="px-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
