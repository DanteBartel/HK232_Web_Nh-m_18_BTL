			...
			?>">
				...
				<div class="flex overflow-x-scroll">
					...
					<?php foreach ($books as $book): ?>
						<div class="bg-white flex flex-col border border-gray-200 rounded-lg shadow mx-4 flex-none<?php
						parseResponsiveCSS([
							'' => ['w-3/5'],
							'md' => ['w-1/4'],
							'xl' => ['w-1/5']
						...
						?>">
							...
							<div class="flex items-center justify-center w-auto h-3/5 rounded-lg overflow-hidden">
								<a href="index.php?action=book&id=<?php echo $book->id ?>">
									<img class="object-contain" src="<?php echo $book->image; ?>" alt="Book cover" />
								</a>
							</div>
