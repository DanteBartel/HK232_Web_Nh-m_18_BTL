<div class="max-w-60 rounded overflow-hidden shadow-lg hover-fade">
	...
	<div class="px-3 py-2">
		...
		<div class="flex items-center mb-2">
			...
			<div class="text-xl font-bold"><?php echo $book->price; ?> VND</div>
			<button
		...
		<button
			class="flex items-center justify-center w-full bg-violet-900 bg-opacity-70 hover:bg-violet-900 hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
